...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jawnz.gate.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jawnz.gate.security.DomainUserDetailsService", "createSpringSecurityUser");
